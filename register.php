...
if(isset($_POST['submit'])){
    ...
    if($password == $cpassword){
        ...
        if($result->num_rows>0){
            ...
            $sql = "INSERT INTO users (restaurant, address, landmark, contact, email, password)
                VALUES ('$restaurant', '$address', '$landmark', '$contact', '$email', '$password')";
            $result = mysqli_query($conn , $sql);
            if($result){
            ...
            <div class="container-form">
                <form action="" method="POST" class="login-email">
                    ...
                    <div class="input-group">
                        <input type="text" placeholder="Restaurant Name" name="restaurant" value="<?php echo $restaurant; ?>" required>
                    </div>
                    <div class="input-group">
